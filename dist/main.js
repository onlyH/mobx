...
map["delete"]('a');
console.log(map.has('a')); // 基本数据类型必须要用observable.box
...
store.number = 100; // when提供了条件执行逻辑，autorun的一种变种
...
console.log('after'); // reaction分离可观察数据声明，以副作用的方式对autorun做出改进
